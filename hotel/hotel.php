...
class Hotel
{
	...
	public function afficherReservationHotel()
	{
		...
		return $result ."<p style = 'background :green'RESERVATION(S) </p>". $compteur." Reservation<br>" ; // lorsqu'un return il sort de la fonction if faut donc cumuler les variables pour les afficher
