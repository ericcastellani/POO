...
$kylianmbappe = new Joueur("MBAPPE","Kylian","1998-12-20",$nationalite1,$club1);
$kylianmbappe2=new Joueur("MBAPPE","Kylian","1998-12-20",$nationalite1,$club2);
...
$alphonseareola = new Joueur("AREOLA","Alphonse","1993-02-27",$nationalite1,$club2);
$raphaelvarane = new Joueur("VARANE","Raphael","1993-04-25",$nationalite1,$club1);
$jordanveretout = new Joueur("VERETOUT","Jordan","1993-03-01",$nationalite1,$club2);
$adrienrabiot = new Joueur("RABIOT","Adrien","1995-04-03",$nationalite1,$club1);
$lucashernandez = new Joueur("HERNANDEZ","Lucas","1996-02-14",$nationalite1,$club2);
...
$aymericlaporte = new Joueur("LAPORTE","Aymeric","1994-05-27",$nationalite2,$club1);
$ansufati = new Joueur("FATI","Ansu","2002-10-31",$nationalite2,$club2);
$alvaromorata = new Joueur("MORATA","Alvaro","1992-10-23",$nationalite2,$club1);
